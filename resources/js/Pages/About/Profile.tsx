...
export default function Profile({ schoolProfile }: Props) {
    return (
        <PublicLayout>
            ...
            {/* 1. Header Hero */}
            <div className="bg-[#F8FDF9] py-20 border-b border-green-50 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <Badge className="bg-white text-primary border-primary/20 mb-4 px-4 py-1">Tentang Kami</Badge>
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Mengenal Lebih Dekat <br/><span className="text-primary">{schoolProfile?.name || 'SMK Bina Insan Mulia'}</span></h1>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="md:w-1/3 relative">
                            <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-gray-100 border-[8px] border-white shadow-xl relative z-10">
                        ...
                        <div className="md:w-2/3">
                            ...
                            <h2 className="text-3xl font-bold mb-2 text-gray-900">Sambutan Kepala Sekolah</h2>
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-100 flex gap-12">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-gray-500">Guru Tersertifikasi</div>
                                </div>
                            </div>
                        </div>
                    </div>
             ...
             <section className="py-20 bg-[#FFF8F2]">
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12">
                        {/* Visi */}
                        <div className="bg-white p-10 rounded-[2.5rem] shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                            <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                                <Target size={120} />
                            </div>
                            <div className="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center text-primary mb-6">
                                <Target size={32} />
                            </div>
                        ...
                        <div className="bg-white p-10 rounded-[2.5rem] shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                            ...
                            <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center text-secondary mb-6">
                                <Flag size={32} />
                            </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600 bg-slate-50 p-10 rounded-[2rem]">
