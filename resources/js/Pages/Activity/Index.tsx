            ...
            <Head title={title} />
             ...
             <div className="bg-[#F8FDF9] py-20 border-b border-green-50">
                <div className="container mx-auto px-4 text-center">
                    <Badge className="bg-white text-primary border-primary/20 mb-4 px-4 py-1">Kegiatan</Badge>
            ...
            <div className="container mx-auto px-4 py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {activities.data?.length > 0 ? activities.data.map((item: any) => (
                         <Card key={item.id} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group h-full flex flex-col">
                            <div className="aspect-video bg-gray-100 relative overflow-hidden">
                                ...
                                <div className="absolute top-4 left-4">
                                     <Badge className="bg-white/90 text-gray-900 backdrop-blur-sm border-0 shadow-sm flex items-center gap-1.5">
                        ...
                        <div className="col-span-full text-center py-20 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                            ...
                            <p className="text-gray-500">Saat ini belum ada data kegiatan yang ditampilkan.</p>
                        </div>
                    )}
                </div>
