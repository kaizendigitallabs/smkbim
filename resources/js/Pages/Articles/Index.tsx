        ...
        <PublicLayout>
            ...
            <div className="bg-[#F8FDF9] py-20 border-b border-green-50">
                <div className="container mx-auto px-4 text-center">
                    <Badge className="bg-white text-primary border-primary/20 mb-4 px-4 py-1">Informasi</Badge>
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Berita & Artikel Terkini</h1>
                    ...
                    <form onSubmit={handleSearch} className="max-w-md mx-auto relative">
                        <Input 
                            ...
                            className="pl-12 h-12 rounded-full shadow-sm border-gray-200 focus:border-primary focus:ring-primary/20"
                            value={search}
            ...
            <div className="container mx-auto px-4 py-20">
                ...
                {currentCategory && (
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        <Link href={route('articles.index')} className="text-sm text-gray-500 hover:text-primary">Reset Filter</Link>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {articles.data?.length > 0 ? articles.data.map((article: any) => (
                        <Link key={article.id} href={route('articles.show', article.slug)} className="group h-full">
                            <Card className="h-full border-0 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
                                <div className="aspect-[16/10] overflow-hidden relative">
                                    <Badge className="absolute top-4 left-4 z-10 bg-white/90 text-gray-900 border-0 backdrop-blur-sm shadow-sm hover:bg-white">
                                        {article.category}
                                    </Badge>
                                    {article.image ? (
                        ...
                        <div className="col-span-3 text-center py-20 bg-gray-50 rounded-2xl">
