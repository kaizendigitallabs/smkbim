        ...
        <PublicLayout>
            ...
            <div className="bg-gray-50 border-b">
                <div className="container mx-auto px-4 py-4">
                    <Link href="/berita" className="text-sm text-gray-500 hover:text-primary flex items-center gap-1">
            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                 ...
                 {article.image && (
                    <div className="rounded-3xl overflow-hidden mb-12 shadow-xl border-4 border-white bg-gray-100">
                        <img src={`/storage/${article.image}`} alt={article.title} className="w-full object-cover max-h-[500px]" />
                    </div>
                 )}

                 <div className="prose prose-lg prose-green max-w-none mb-20 text-gray-700 leading-loose">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {relatedArticles.map((rel) => (
                                <Link href={route('articles.show', rel.slug)} key={rel.id} className="group h-full">
                                    <Card className="h-full border-0 shadow-sm hover:shadow-lg transition-all overflow-hidden flex flex-col">
                                        ...
                                        <CardContent className="p-5 flex-1 flex flex-col">
                                            ...
                                            <h4 className="font-bold text-gray-900 group-hover:text-primary transition-colors line-clamp-2 mb-2">{rel.title}</h4>
