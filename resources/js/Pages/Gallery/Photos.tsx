        ...
        <PublicLayout>
            ...
            <div className="bg-[#F8FDF9] py-20 border-b border-green-50">
                <div className="container mx-auto px-4 text-center">
                    <Badge className="bg-white text-primary border-primary/20 mb-4 px-4 py-1">Dokumentasi</Badge>
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Galeri Foto Sekolah</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {galleries.data?.length > 0 ? galleries.data.map((item: any) => (
                        ...
                        <div className="col-span-full py-20 text-center">
                            ...
                            <p className="text-gray-500">Galeri foto akan segera diupdate.</p>
                        </div>
                    )}
                </div>
